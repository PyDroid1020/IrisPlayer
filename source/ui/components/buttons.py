import flet as ft
from ...theme import DARK_ACCENT,PLAYER_BUTTONS_COLORS,PLAYER_SPECIAL_BUTTONS_COLORS
...
def getButtons(player):
    icon_size = 30
    buttons = [
        ft.IconButton(icon=ft.Icons.SHUFFLE_OUTLINED, icon_color=PLAYER_SPECIAL_BUTTONS_COLORS, icon_size=icon_size ,on_click=player.toggle_shuffle),
        ...
        ft.IconButton(icon=ft.Icons.PLAY_ARROW, icon_color=PLAYER_SPECIAL_BUTTONS_COLORS, icon_size=icon_size ,on_click=player.toggle_play),
        ...
        ft.IconButton(icon=ft.Icons.REPEAT_OUTLINED, icon_color=PLAYER_SPECIAL_BUTTONS_COLORS, icon_size=icon_size ,on_click=player.toggle_loop),
    ]
    return buttons
