...
def get_player_view(page: ft.Page, playlist_name: str, open_main_list_view_fn):
    ...
    current_thumb = ft.Container(
        content=ft.Icon(ft.Icons.MUSIC_NOTE, color=ft.Colors.GREY),
        width=56,
        height=56,
    ...
    progress_slider = ft.Slider(
        ...
        thumb_color=ft.Colors.with_opacity(0.5, ft.Colors.WHITE12),
        expand=True,
        height=4,
    )
    ...
    def song_tile(song, list_index):
        ...
        img = ft.Image(
            src=song.get("thumbnail_path", ""),
            width=44,
            height=44,
            fit=ft.ImageFit.COVER,
            border_radius=6,
            filter_quality=ft.FilterQuality.HIGH
        ) if song.get("thumbnail_path") else None

        thumb = ft.Container(
            content=img or ft.Icon(ft.Icons.MUSIC_NOTE, color=ft.Colors.GREY),
            width=44,
            height=44,
            bgcolor=ft.Colors.ON_SURFACE_VARIANT if not img else None,
        ...
        favorite_btn = ft.IconButton(
            icon=star_icon,
            icon_color=ft.Colors.LIGHT_BLUE_100,
        ...
        more_menu = ft.PopupMenuButton(
            ...
            items=[
                ft.PopupMenuItem(
                    content=ft.Row([ft.Icon(ft.Icons.EDIT_NOTE), ft.Text("Edit")], spacing=5),
                    on_click=edit_song
                ),
                ft.PopupMenuItem(
                    content=ft.Row([ft.Icon(ft.Icons.DELETE_FOREVER), ft.Text("Delete")], spacing=5),
                    on_click=delete_song
                )
            ]
        )
    ...
    player_controls = ft.Container(
        content=ft.Row([
            ft.Container(
                content=ft.Row([
                    current_thumb,
                    ft.Column([current_song_text, current_playlist_text], spacing=2, width=150, alignment=ft.MainAxisAlignment.CENTER)
            ...
            ft.Container(
                content=ft.Row([shuffle_icon, loop_icon, ft.Icon(ft.Icons.VOLUME_UP, color=ft.Colors.GREY, size=18), volume_slider], spacing=8, alignment=ft.MainAxisAlignment.END),
                width=200
            )
